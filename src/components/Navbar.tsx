  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-24">
        ...
        <a
          href="#contact"
          className="inline-flex font-body text-h-20 md:h-40 object-contain font-medium tracking-[0.3em] uppercase text-muted-foreground hover:text-primary transition-colors duration-500"
        >
          Contattaci
        </a>
      </div>
