...
const contactInfo = [
  { icon: Phone, key: "phone" as const, value: "+39 02 1234 5678", href: "tel:+390212345678" },
  { icon: Phone, key: "phone" as const, value: "+39 02 1234 5678", href: "tel:+390212345678" },
  { icon: Mail, key: "email" as const, value: "info@arteventstudio.it", href: "mailto:info@arteventstudio.it" },
  { icon: MapPin, key: "address" as const, value: "Via Callesella, 1425, 37040 Zimella VR", href: "https://maps.app.goo.gl/j3BSYqzer5mX5bsb7" },
];
        ...
        <div className="grid md:grid-cols-2 gap-px bg-border/30">
          {contactInfo.map((item, i) => (
            ...
            >
              ...
              <p className="font-body text-[10px] tracking-[0.4em] uppercase text-primary/70 mb-3">{t[item.key][lang]}</p>
              <p className="font-body text-sm text-foreground/70 group-hover:text-foreground transition-colors duration-500 leading-relaxed">{item.value}</p>
            </motion.a>
          ))}
        </div>
      </div>
