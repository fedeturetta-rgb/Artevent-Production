...
const DroneVenezia = () => {
  return (
    <section className="min-h-screen px-6 py-32 max-w-5xl mx-auto">
      ...
      >
        Riprese con Drone a Venezia, Video Aerei e Fotografia Aerea Professionale
      </motion.h1>

      <p className="mb-6 text-foreground/70">
        Artevent Production realizza riprese con drone a Venezia per aziende, brand e attività che vogliono ottenere contenuti visivi ad alto impatto. Produciamo video aerei e fotografia aerea professionale per valorizzare location, strutture e progetti.
      </p>
      ...
      <h2 className="text-2xl mb-6">Riprese con drone a Venezia per aziende</h2>

      <p className="text-foreground/70 mb-6">
        Realizziamo riprese con drone a Venezia per aziende che vogliono migliorare la propria comunicazione visiva attraverso video aerei professionali.
      </p>
      ...
      <p className="text-foreground/70 mb-6">
        Produciamo video aerei cinematici a Venezia con droni professionali, progettati per integrarsi perfettamente in produzioni video corporate e commerciali.
      </p>
      ...
      <p className="text-foreground/70 mb-6">
        Oltre ai video, realizziamo fotografia aerea a Venezia per aziende, immobili, strutture ricettive e progetti architettonici.
      </p>
      ...
      <h2 className="text-2xl mb-6">Perché scegliere Artevent Production per le riprese drone a Venezia</h2>
      ...
      <p className="text-foreground/70 mb-6">
        ...
        <a href="/produzione-video-corporate-venezia" className="underline"> produzione video corporate a Venezia</a> 
        e la 
      ...
      <p className="text-foreground/70 mb-10">
        ...
        <a href="/riprese-drone-verona"> Verona</a>, 
