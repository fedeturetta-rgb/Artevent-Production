...
const CorporateRovigo = () => {
  return (
    <section className="min-h-screen px-6 py-32 max-w-5xl mx-auto">
      ...
      >
        Produzione Video Aziendali, Fotografia Corporate e Riprese Drone a Rovigo
      </motion.h1>

      <p className="mb-6 text-foreground/70">
        Artevent Production è specializzata nella produzione di video aziendali, fotografia corporate e riprese con drone a Rovigo, aiutando aziende e brand a comunicare con contenuti visivi di alto livello.
      </p>
      ...
      <h2 className="text-2xl mb-6">Video aziendali e video corporate a Rovigo</h2>

      <p className="text-foreground/70 mb-6">
        Produciamo video aziendali e corporate a Rovigo per siti web, campagne marketing e comunicazione interna, sviluppando contenuti su misura per ogni brand.
      </p>
      ...
      <h2 className="text-2xl mb-6">Fotografia aziendale e fotografia corporate a Rovigo</h2>

      <p className="text-foreground/70 mb-6">
        Realizziamo fotografia aziendale e corporate a Rovigo per creare un’immagine forte e coerente su sito web, social e materiali marketing.
      </p>
      ...
      <h2 className="text-2xl mb-6">Riprese con drone a Rovigo e video aerei</h2>

      <p className="text-foreground/70 mb-6">
        Le riprese con drone a Rovigo permettono di ottenere immagini ad alto impatto visivo e prospettive uniche per aziende e location.
      </p>
      ...
      <h2 className="text-2xl mb-6">Servizi di produzione video e fotografia aziendale a Rovigo</h2>
      ...
      <h2 className="text-2xl mb-6">Perché scegliere Artevent Production a Rovigo</h2>
      ...
      <p className="text-foreground/70 mb-6">
        ...
        <a href="/riprese-drone-rovigo" className="underline"> riprese con drone a Rovigo</a> 
        e 
        <a href="/fotografia-aziendale-rovigo" className="underline"> fotografia aziendale a Rovigo</a>.
      </p>
...
export default CorporateRovigo;