...
const CorporateTrento = () => {
  return (
    <section className="min-h-screen px-6 py-32 max-w-5xl mx-auto">
      ...
      >
        Produzione Video Aziendali, Fotografia Corporate e Riprese Drone a Trento
      </motion.h1>

      <p className="mb-6 text-foreground/70">
        Artevent Production è specializzata nella produzione di video aziendali, fotografia corporate e riprese con drone a Trento, aiutando aziende e brand a comunicare con contenuti visivi di alto livello.
      </p>
      ...
      <h2 className="text-2xl mb-6">Video aziendali e video corporate a Trento</h2>

      <p className="text-foreground/70 mb-6">
        Produciamo video aziendali e corporate a Trento per siti web, campagne marketing e comunicazione interna, sviluppando contenuti su misura per ogni brand.
      </p>
      ...
      <h2 className="text-2xl mb-6">Fotografia aziendale e fotografia corporate a Trento</h2>

      <p className="text-foreground/70 mb-6">
        Realizziamo fotografia aziendale e corporate a Trento per creare un’immagine forte e coerente su sito web, social e materiali marketing.
      </p>
      ...
      <h2 className="text-2xl mb-6">Riprese con drone a Trento e video aerei</h2>

      <p className="text-foreground/70 mb-6">
        Le riprese con drone a Trento permettono di ottenere immagini ad alto impatto visivo e prospettive uniche per aziende e location.
      </p>
      ...
      <h2 className="text-2xl mb-6">Servizi di produzione video e fotografia aziendale a Trento</h2>
      ...
      <h2 className="text-2xl mb-6">Perché scegliere Artevent Production a Trento</h2>
      ...
      <p className="text-foreground/70 mb-6">
        ...
        <a href="/riprese-drone-trento" className="underline"> riprese con drone a Trento</a> 
        e 
        <a href="/fotografia-aziendale-trento" className="underline"> fotografia aziendale a Trento</a>.
      </p>
