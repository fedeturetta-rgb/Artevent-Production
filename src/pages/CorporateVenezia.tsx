...
const CorporateVenezia = () => {
  return (
    <section className="min-h-screen px-6 py-32 max-w-5xl mx-auto">
      ...
      >
        Produzione Video Aziendali, Fotografia Corporate e Riprese Drone a Venezia
      </motion.h1>

      <p className="mb-6 text-foreground/70">
        Artevent Production è specializzata nella produzione di video aziendali, fotografia corporate e riprese con drone a Venezia, aiutando aziende e brand a comunicare con contenuti visivi di alto livello.
      </p>
      ...
      <h2 className="text-2xl mb-6">Video aziendali e video corporate a Venezia</h2>

      <p className="text-foreground/70 mb-6">
        Produciamo video aziendali e corporate a Venezia per siti web, campagne marketing e comunicazione interna, sviluppando contenuti su misura per ogni brand.
      </p>
      ...
      <h2 className="text-2xl mb-6">Fotografia aziendale e fotografia corporate a Venezia</h2>

      <p className="text-foreground/70 mb-6">
        Realizziamo fotografia aziendale e corporate a Venezia per creare un’immagine forte e coerente su sito web, social e materiali marketing.
      </p>
      ...
      <h2 className="text-2xl mb-6">Riprese con drone a Venezia e video aerei</h2>

      <p className="text-foreground/70 mb-6">
        Le riprese con drone a Venezia permettono di ottenere immagini ad alto impatto visivo e prospettive uniche per aziende e location.
      </p>
      ...
      <h2 className="text-2xl mb-6">Servizi di produzione video e fotografia aziendale a Venezia</h2>
      ...
      <h2 className="text-2xl mb-6">Perché scegliere Artevent Production a Venezia</h2>
      ...
      <p className="text-foreground/70 mb-6">
        ...
        <a href="/riprese-drone-venezia" className="underline"> riprese con drone a Venezia</a> 
        e 
        <a href="/fotografia-aziendale-venezia" className="underline"> fotografia aziendale a Venezia</a>.
      </p>
